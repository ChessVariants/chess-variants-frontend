import { Button, Container, Divider, Grid, IconButton, MenuItem, Paper, Select, SelectChangeEvent, styled, TextField, Typography } from "@mui/material";
...
export default function CreateGame(props: { createGameFunction: any }) {
    ...
    const createLobby = () => {
        if (textFieldVariant === "") {
            props.createGameFunction(selectVariant);
        }
        else {
            props.createGameFunction(textFieldVariant);
        }
